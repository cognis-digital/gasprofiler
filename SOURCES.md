...
- **feed** · https://www.rigzone.com/news/rss/rigzone_latest.aspx
- **feed** · https://www.spglobal.com/commodityinsights/en/rss-feed/oil
- **live search** · `OPEC production quota 2026`
- **live search** · `LNG export terminal capacity`
- **live search** · `power grid strain electricity demand AI datacenter`
- **live search** · `uranium nuclear fuel supply 2026`
- **api** · https://www.eia.gov/opendata/ (US EIA energy data, free key)
- **api** · https://www.iea.org (IEA reports)
