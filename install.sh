#!/usr/bin/env sh
# Universal installer for gasprofiler. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/gasprofiler.git"
echo "Installing gasprofiler ..."
...
echo "Done. Run: gasprofiler --help"
